...
BASE_FOLDER_PATH = Path(r"C:\Badri\IPC\GenAIPOC")
...
#---------------------- LOG PATHS ----------------------------------------------------------
LOG_PATH_CIRCUIT = BASE_FOLDER_PATH / "agents/circuit_agent/logs"
LOG_PATH_CIRCUIT_LOGFILE = LOG_PATH_CIRCUIT / "circuit_agent.log"

LOG_PATH_INVOICE = BASE_FOLDER_PATH / "agents/invoice_agent/logs"
...
#---------------------- CIRCUIT PATHS ------------------------------------------------------
CIRCUIT_BASE_FOLDER_PATH = BASE_FOLDER_PATH / "agents/circuit_agent/embedder/data"
...
#---------------------- INVOICE PATHS ------------------------------------------------------
INVOICE_BASE_FOLDER_PATH = BASE_FOLDER_PATH / "agents/invoice_agent/embedder/data"
